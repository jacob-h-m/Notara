...
function TipTapTabPanel({
  ...
  // When parent content changes externally (e.g. version restore, file reload)
  // sync it back into TipTap without triggering onUpdate loop.
  useEffect(() => {
    if (!editor || !isActive) return
    // Use a small timeout so the tab has fully appeared before measuring
